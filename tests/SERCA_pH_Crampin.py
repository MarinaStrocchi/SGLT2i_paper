...
g_SERCA_pH_ref = g_SERCA * 1.0/(1.0 + np.power(10.0000, n_up * (-pH_ref + pKup)))
g_SERCA_pH_high = g_SERCA * 1.0/(1.0 + np.power(10.0000, n_up * (-pH_high + pKup)))
g_SERCA_pH_low = g_SERCA * 1.0/(1.0 + np.power(10.0000, n_up * (-pH_low + pKup)))
...
def SERCA_factor_pH(pH):
	...
	return 1.0/(1.0 + np.power(10.0000, n_up * (-pH + pKup)))
