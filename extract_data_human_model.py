...
source_folder = "/media/mstrocch/MS_5/SGLT2i_Mike_Shattock/human_model_torord_endo/"
output_folder = "./human_model/"
...
df_data.to_csv(os.path.join(output_folder,"human_model_metrics.csv"),float_format="%g")